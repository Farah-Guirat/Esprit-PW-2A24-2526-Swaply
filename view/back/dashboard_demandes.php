...
<head>
    ...
    <title>Dashboard Admin - Demandes</title>
    ...
    <i class="fa-solid fa-house"></i> Dashboard
       ...
       <a href="/swaply/view/back/projets.php" onclick="showPage('projets')" class="menu-item" id="menu-projets">
        <i class="fa-solid fa-file"></i> Projets
           ...
           <a href="/swaply/view/back/reclamations_admin.php" class="menu-item" id="menu-reclamations">
    ...
    <div class="main-content">
        ...
        <div class="p-8 max-w-7xl mx-auto w-full">
            ...
            <div class="w-full flex justify-between items-center mb-6">
                <a href="index.php?action=dashboard" class="flex items-center gap-2 bg-white border border-gray-300 hover:bg-gray-50 px-4 py-2 rounded-xl text-sm font-medium">
                ...
                <table class="w-full">
                    <thead class="bg-gray-50 border-b">
                        <tr>
                            ...
                            <th class="p-5 text-center">Date création</th>
                    ...
                    <tbody id="tableBody">
                        ...
                        <tr class="border-b hover:bg-gray-50 transition-colors" data-statut="<?= $statutLower ?>">
                            <td class="p-5 font-medium"><?= htmlspecialchars($demande->getTitre()) ?></td>
                            <td class="p-5 text-center"><?= htmlspecialchars($demande->getCategorie()) ?></td>
                            <td class="p-5 text-center"><?= htmlspecialchars($demande->getNiveau()) ?></td>
                            <td class="p-5 text-center text-sm">
                                <?= $demande->getDateCreation() ? $demande->getDateCreation()->format('d/m/Y') : '-' ?>
                            </td>
...
<div id="blockModal" class="hidden fixed inset-0 bg-black/60 flex items-center justify-center z-50">
    <div class="bg-white rounded-3xl p-8 max-w-md w-full mx-4">
        <h3 class="text-xl font-semibold mb-2" id="blockTitle">Bloquer cette demande ?</h3>
        <p class="text-gray-600 mb-8" id="blockMessage">La demande ne sera plus visible publiquement.</p>
        <div class="flex gap-3">
    ...
    try {
        ...
        visibleRows.forEach(row => {
            ...
            Array.from(row.querySelectorAll('td')).forEach((td, index) => {
                ...
                rowsHtml += '<td style="' + cellStyle + '">' + cellContent + '<tr>';
            });
            rowsHtml += '</tr>';
        });
        let headerRow = '';
...
function initAllCharts() {
    ...
    doughnutChart = new Chart(ctxDoughnut, {
        ...
        options: {
            ...
            cutout: '68%',
            plugins: { legend: { position: 'bottom', labels: { padding: 25, font: { size: 15 }, usePointStyle: true } } }
        }
    });
