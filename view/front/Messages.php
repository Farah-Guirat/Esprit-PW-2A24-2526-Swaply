...
<!-- NAVBAR -->
<nav class="navbar">
    <a class="navbar-brand" href="swaplyf.php">
        <div class="navbar-logo">S</div>
        Swaply
    </a>
    <div class="navbar-links">
        <a href="swaplyf.php">Accueil</a>
        ...
        <a href="/swaply/view/front/messagerie.php" class="active">Messages</a>
    ...
    <div class="navbar-user-menu">
        ...
        <div class="navbar-dropdown" id="userDropdown">
            <div class="navbar-dropdown-header">
                <strong><?= htmlspecialchars($_SESSION['user']['prenom'] ?? '') ?> <?= htmlspecialchars($_SESSION['user']['nom'] ?? '') ?></strong>
