...
<title>Réclamations – Swaply Admin</title>
<link rel="stylesheet" href="styles.css">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
<style>
body { display:flex; min-height:100vh; }
.recl-main { flex:1; display:flex; flex-direction:column; overflow-y:auto; background:#f8fafc; }
.recl-topbar { height:70px; background:#fff; border-bottom:1px solid #e2e8f0; display:flex; align-items:center; padding:0 30px; gap:16px; position:sticky; top:0; z-index:50; justify-content:space-between; }
.recl-topbar-title { font-size:22px; font-weight:600; color:#0f766e; }
.recl-topbar-right { display:flex; align-items:center; gap:16px; }
.recl-search-box { display:flex; align-items:center; gap:8px; background:#f1f5f9; border-radius:40px; padding:8px 16px; width:240px; }
.recl-search-box input { border:none; background:none; font-size:14px; outline:none; width:100%; }
.recl-avatar { width:38px; height:38px; border-radius:50%; background:#d1d5db; display:flex; align-items:center; justify-content:center; font-size:14px; color:#6b7280; border:2px solid #e2e8f0; }
.logout-btn-recl { display:flex; align-items:center; gap:8px; background:#fee2e2; color:#dc2626; padding:8px 16px; border-radius:30px; font-size:13px; font-weight:500; text-decoration:none; transition:all 0.2s; }
.logout-btn-recl:hover { background:#fecaca; }
.adm-page-content { padding:28px; }
/* ── Variables ── */
:root {
  --teal:   #14b8a6;
  --teal-d: #0f766e;
...
<div class="sidebar">
    ...
    <div class="menu">
        ...
        <a href="/swaply/view/back/messages.php"            class="menu-item"><i class="fa-solid fa-envelope"></i> Messages</a>
        <a href="/swaply/view/back/reclamations_admin.php"  class="menu-item active"><i class="fa-solid fa-exclamation-triangle"></i> Réclamations</a>
...
<!-- ── MAIN ── -->
<div class="recl-main">
    <div class="recl-topbar">
        <div class="recl-topbar-title">Réclamations</div>
        <div class="recl-topbar-right">
            <div class="recl-search-box">
                <i class="fa-solid fa-magnifying-glass"></i>
                <input type="text" placeholder="Rechercher...">
            </div>
            <i class="fa-solid fa-bell fa-lg" style="color:#64748b;cursor:pointer;"></i>
            <div class="recl-avatar">A</div>
            <div style="line-height:1.3;"><strong style="display:block;font-size:14px;color:#0f172a;">Admin</strong><span style="font-size:12px;color:#64748b;">Super Admin</span></div>
            <a href="/swaply/controller/logout.php" class="logout-btn-recl" onclick="return confirm('Êtes-vous sûr de vouloir vous déconnecter ?');">
