...
require_once __DIR__ . '/../OffreDemandeControllers/OffreController.php';
require_once __DIR__ . '/../OffreDemandeControllers/FrontControllerDemande.php';

require_once __DIR__ . '/../OffreDemandeControllers/DashboardController.php';
require_once __DIR__ . '/../OffreDemandeControllers/DashboardControllerDemande.php';
...
switch ($action) {
    ...
    // ================= HOME =================
    case 'swaplyf':
        require __DIR__ . '/../view/front/swaplyf.php';
        break;


        case 'choicee':
include __DIR__ . '/../view/front/offres_choice.php';    break;

 case 'choice':
include __DIR__ . '/../view/front/demande_choice.php';    break;
    ...
    case 'add':
require __DIR__ . '/../view/front/offre_add.php';       break;


  case 'add_demande':
require __DIR__ . '/../view/front/demande_add.php';       break;
...
case 'deleted':
   ...
   // ================= DASHBOARD =================
      case 'back':
     require __DIR__ . '/../view/back/swaplyB.php';
                break;
   ...
   case 'detailsoffre':
    ...
    // ================= DEFAULT =================
    default:
        require __DIR__ . '/../view/front/home.php';
        break;
}