...
<body>
  ...
  <main class="max-w-7xl mx-auto px-8 py-10">
    ...
    <div class="hero-bg rounded-3xl p-12 text-white mb-12">
      <div class="max-w-2xl">
        ...
        <div class="mt-8 flex gap-4">
          ...
          <a href="projet.php" class="border border-white/70 px-8 py-4 rounded-3xl font-semibold text-lg hover:bg-white/10 transition">
            Voir les projets
          </a>
        </div>
      </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      ...
      <a href="projets.php" class="card-hover bg-white rounded-3xl p-6 border border-transparent hover:border-teal-200">
