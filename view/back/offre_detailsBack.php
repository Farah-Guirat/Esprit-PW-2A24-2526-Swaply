...
<div class="flex h-screen overflow-hidden">
    ...
    <div class="main-content">
        ...
        <header class="header" id="main-header">
            <h2 id="page-title">Détails de l'offre</h2>
            ...
            <div class="details-container">
                ...
                <div class="flex items-start justify-between border-b pb-5 mb-5">
                    <h1 class="text-3xl font-bold text-gray-800">
                        <i class="fa-solid fa-briefcase text-blue-500 mr-3"></i>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div class="info-box">
                        ...
                        <p class="font-semibold text-gray-800 text-lg">
                            <?= htmlspecialchars($offre->getCategorie()) ?>
                        </p>
                    </div>
                    ...
                    <div class="info-box">
                        ...
                        <p class="font-semibold text-gray-800 text-lg">
                            <?= htmlspecialchars($offre->getNiveau()) ?>
                        </p>
                    </div>

                    <div class="info-box">
                        <p class="text-sm text-gray-500 mb-1">
                            <i class="fa-solid fa-calendar text-blue-400 mr-1"></i> Date limite
                        </p>
                        <p class="font-semibold text-gray-800 text-lg">
                            <i class="fa-regular fa-calendar-alt mr-2 text-gray-400"></i>
                            <?= $offre->getDateLimite()?->format('d/m/Y') ?>
                        </p>
                    </div>

                    <div class="info-box">
                        <p class="text-sm text-gray-500 mb-1">
                            <i class="fa-solid fa-eye text-blue-400 mr-1"></i> Nombre de vues
                        </p>
                        <div class="mt-1">
...
<div id="deleteModal" class="hidden fixed inset-0 bg-black/60 flex items-center justify-center z-50">
    <div class="bg-white rounded-3xl p-8 max-w-md w-full mx-4">
        ...
        <p class="text-gray-600 mb-6">Êtes-vous sûr de vouloir supprimer cette offre ? Cette action est irréversible.</p>
        <div class="flex gap-3">
...
<div id="blockModal" class="hidden fixed inset-0 bg-black/60 flex items-center justify-center z-50">
    <div class="bg-white rounded-3xl p-8 max-w-md w-full mx-4">
        <div class="flex items-center gap-3 mb-4">
            ...
            <h3 class="text-xl font-semibold" id="blockTitle">Bloquer cette offre ?</h3>
        </div>
        <p class="text-gray-600 mb-6" id="blockMessage">L'offre ne sera plus visible publiquement après blocage.</p>
        <div class="flex gap-3">
